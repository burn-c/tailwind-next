...
export function Trigger() {
  ...
  return (
    <label
      ...
      shadow-sm hover:border-violet-200 hover:bg-violet-25 hover:text-violet-500 dark:border-zinc-800 dark:bg-zinc-800 dark:hover:border-zinc-700 
      dark:hover:bg-zinc-700 dark:hover:text-violet-300"
    >
